...
if page == "Project Info":
    ...
    with col2:
        ...
        st.markdown("---")
        st.write("**Project description (short):**", value = "The SafeURL Predictor is a machine learning–powered application designed to automatically analyze and classify URLs as benign or malicious. The system extracts key structural and linguistic features from each URL—such as length, entropy, subdomains, presence of suspicious keywords, and potential obfuscation patterns—and feeds them into a trained Random Forest model.
